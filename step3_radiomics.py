...
def main():
  outPath = r''
  inputCSV = os.path.join(outPath, "G:\ilaseg\dataout.csv")
  outputFilepath = r"G:\ilaseg\radiomics_features.csv"
  progress_filename = os.path.join(outPath, "G:\ilaseg\pyrad_log.txt")
  params = os.path.join(outPath, 'exampleSettings', 'Params.yaml')

  #使用CT影像

  params = os.path.join(outPath, 'exampleCT.yaml')
